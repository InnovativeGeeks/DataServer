...
if (isset($data['username']) && isset($data['panelname'])) {
    ...
    //get text panels
    $sql = "SELECT panel_id, dataname, datatype, value FROM textPanels natural join userPanels natural join panels where panel_name = '$panelname' AND username = '$username'";
    ...
    $sql = "SELECT panel_id, dataname, datatype, filename FROM textFilePanels natural join userPanels natural join panels where panel_name = '$panelname' AND username = '$username'";
    ...
    $sql = "SELECT panel_id, dataname, datatype, filename FROM numericCSVPanels natural join userPanels natural join panels where panel_name = '$panelname' AND username = '$username'";
